/*
 * Copyright (c) 2012 www.abive.com. All rights reserved.
 */
...
public class DES {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DES des = new DES("$$ranjc@abive.com Inc. ^1988^ qwertyuiop");

        String s1 = des.encrypt("你好");

        System.out.println(s1);
        System.out.println(des.decrypt(s1));
